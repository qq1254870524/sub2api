export default {
    accounts: {
      ...
      a2gImportHint: 'Enter Grok2API URL + Admin Key; Sub2 backend pulls the pool server-side (SSO→OAuth). File/paste still available under Advanced.',
      ...
      a2gDirectNote: 'Sub2 backend fetches G2A (no browser CORS). Use http://127.0.0.1:8010 locally; Docker may need http://172.24.80.1:8010. Admin Key must be app_key.',
      ...
      a2gKeyHint: 'Admin Key must be G2A app_key (admin login secret), not api_key.',
      a2gFetchCorsHint: 'Ensure G2A is running and reachable from the Sub2 container (try http://172.24.80.1:8010)',
